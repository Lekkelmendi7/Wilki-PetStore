...
namespace Wilki.Migrations
{
    public partial class VendosjaPerderoueseveTeRi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            {
             {
                 "02020202-0202-0202-0202-020202020202", "shites@wilki.com", "SHITES@WILKI.COM",
                 "shites@wilki.com", "SHITES@WILKI.COM", false,
                 ...
                 "03030303-0303-0303-0303-030303030303", "klient@wilki.com", "KLIENT@WILKI.COM",
                 "klient@wilki.com", "KLIENT@WILKI.COM", false,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                     { 2, "Shites", "Shites", "shites@wilki.com", "shites@wilki.com", "02020202-0202-0202-0202-020202020202","1900-01-01T00:00:00.000Z" },
                     { 3, "Klient", "Klient", "klient@wilki.com", "klient@wilki.com", "03030303-0303-0303-0303-030303030303","1900-01-01T00:00:00.000Z" },
            });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
            { 2, 2,  "Prishtine", 10000,  "P.A.", "Kosove",  "shites@wilki.com", "+38345111222",  "Shites",  "Shites" },
            { 3, 3,  "Prishtine", 10000,  "P.A.", "Kosove",  "klient@wilki.com", "+38346111222",  "Klient",  "Klient" },
                });
